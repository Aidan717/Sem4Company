...
namespace Web_API_Service.Service {
	public class DBInfoGenerater : IDBInfoGenerater {
		...
		public string GetRandomStackTrace() {
			...
			switch (indexMessage) {
				...
				case 4:
					...
					break;
				case 5:
					result = "System.Net.Http.ConnectHelper.ConnectAsync(String host, Int32 port, CancellationToken cancellationToken) at System.Net.Http.HttpConnectionPool.ConnectAsync(HttpRequestMessage request, Boolean allowHttp2, CancellationToken cancellationToken) at System.Net.Http.HttpConnectionPool.CreateHttp11ConnectionAsync(HttpRequestMessage request, CancellationToken cancellationToken) at System.Net.Http.HttpConnectionPool.GetHttpConnectionAsync(HttpRequestMessage request, CancellationToken cancellationToken) at System.Net.Http.HttpConnectionPool.SendWithRetryAsync(HttpRequestMessage request, Boolean doRequestAuth, CancellationToken cancellationToken) at System.Net.Http.RedirectHandler.SendAsync(HttpRequestMessage request, CancellationToken cancellationToken) at System.Net.Http.DiagnosticsHandler.SendAsync(HttpRequestMessage request, CancellationToken cancellationToken) at System.Net.Http.HttpClient.FinishSendAsyncBuffered(Task`1 sendTask, HttpRequestMessage request, CancellationT kenSource cts, Boolean disposeCts) at Web_API_Service.Controllers.ElkCheckController.PostCheckIfErrorSingleObject(_Source result) in C:\\Users\\Bjerne\\source\\repos\\Aidan717\\Sem4Company\\Web_API_Service\\Controllers\\ElkCheckController.cs:line 399";
					break;
				//case 6:
		...
		public string GetRandomInnerException() {
			...
			switch (indexMessage) {
				...
				case 2:
					...
					break;
				case 3:
					result = "System.Net.Sockets.SocketException (11001): Værten kendes ikke. at System.Net.Http.ConnectHelper.ConnectAsync(String host, Int32 port, CancellationToken cancellationToken)";
					break;
				case 4:
					...
					break;
				case 5:
					result = "System.Net.Sockets.SocketException at Web_API_Service.Controllers.ElkCheckController.AbuseThisGenerater(Int32 amount) by calling the ThrowInner method";
					break;
					//case 6:
					//	result = "Nullpointer exception";
					//	break;
		...
		public string GetRandomFailedRecipient() {
			string result = "";
			int indexMessage = numGenenerater.Next(4, 7);
